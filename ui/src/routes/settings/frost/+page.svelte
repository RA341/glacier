<script lang="ts">
    import {AlertCircleIcon, LoaderIcon, SaveIcon, SettingsIcon} from '@lucide/svelte';
    ...
    <div class="max-w-4xl mx-auto p-8 min-h-screen">
        ...
        <header class="sticky top-0 z-30 bg-background/80 backdrop-blur-md border-b border-border mb-10 -mx-8 px-8 py-6 flex justify-between items-center">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-black uppercase tracking-tight text-foreground leading-tight">
                        Frost Settings
                    </h1>
                    <p class="text-xs text-muted font-medium uppercase tracking-wider">
                        Configure frost client
                    </p>
                </div>
            </div>
