...
INSERT INTO `new_folder_manifests` (`id`, `created_at`, `updated_at`, `deleted_at`, `game_id`, `total_size`, `available_exe_paths`, `file_info`) SELECT `id`, `created_at`, `updated_at`, `deleted_at`, `game_id`, `total_size`, `available_exe_paths`, `file_info` FROM `folder_manifests`;
