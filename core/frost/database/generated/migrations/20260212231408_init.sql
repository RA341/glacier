...
INSERT INTO `new_local_games` (`id`, `created_at`, `updated_at`, `deleted_at`, `game_id`, `provider_type`, `game_db_id`, `name`, `short_desc`, `full_desc`, `url`, `thumbnail_url`, `videos`, `platforms`, `genres`, `rating`, `rating_count`, `release_date`, `release_status`, `category`, `client`, `download_id`, `state`, `complete`, `left`, `progress`, `download_url`, `download_path`, `incomplete_path`, `indexer_type`, `game_type`, `title`, `image_url`, `file_size`, `created_iso`, `exe`, `status`, `status_message`, `started`, `done`, `launch_exe`) SELECT `id`, `created_at`, `updated_at`, `deleted_at`, `game_id`, `provider_type`, `game_db_id`, `name`, `short_desc`, `full_desc`, `url`, `thumbnail_url`, `videos`, `platforms`, `genres`, `rating`, `rating_count`, `release_date`, `release_status`, `category`, `client`, `download_id`, `state`, `complete`, `left`, `progress`, `download_url`, `download_path`, `incomplete_path`, `indexer_type`, `game_type`, `title`, `image_url`, `file_size`, `created_iso`, `exe`, `status`, `status_message`, `started`, `done`, `launch_exe` FROM `local_games`;
