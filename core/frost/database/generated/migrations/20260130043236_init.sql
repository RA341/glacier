...
INSERT INTO `new_local_games` (`id`, `created_at`, `updated_at`, `deleted_at`, `provider_type`, `game_db_id`, `name`, `short_desc`, `full_desc`, `url`, `thumbnail_url`, `videos`, `platforms`, `genres`, `rating`, `rating_count`, `release_date`, `release_status`, `category`, `download_path`, `installer_path`, `exe_path`, `status`, `status_message`) SELECT `id`, `created_at`, `updated_at`, `deleted_at`, `provider_type`, `game_db_id`, `name`, `summary`, `description`, `url`, `thumbnail_url`, `videos`, `platforms`, `genres`, `rating`, `rating_count`, `release_date`, `release_status`, `category`, `download_path`, `installer_path`, `exe_path`, `status`, `status_message` FROM `local_games`;
